// Service worker for Shanghai Solitaire. Cache-first for everything, including
// navigations — a slow network hangs a fetch, it doesn't reject it, so falling
// back to cache only on failure is not enough. VERSION is a hash of the
