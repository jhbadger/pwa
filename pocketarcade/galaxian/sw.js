...
self.addEventListener('activate', e => {
  ...
  // several unrelated apps (including the two other Space Invaders apps
  // elsewhere in this project) — only ever touch caches with our own prefix.
  e.waitUntil(
